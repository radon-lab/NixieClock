...
Обычный режим управления -
    ...
    Клик по "средней" кнопке отображает текущий режим анимации смены минут, затем:
        ...
        Удержание "средней" кнопки во время отображения режима анимации смены минут(если нет дополнительной кнопки) - переводит в режим установки анимации смены секунд, выбор анимации осуществляется "правой" кнопкой.
