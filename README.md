...
Пункты меню:
    ...
    11 - Выбор анимации антиотравления индикаторов(0 - перебор всех индикаторов | 1 - перебор одного индикатора | 2 - перебор одного индикатора с отображением времени) и анимации секунд(0 - выкл | 1 - плавная смена яркостью | 2 - перебор по порядку числа)(антиотравление : анимация секунд)
