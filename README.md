...
Что планируется:
    ...
    Добавить поддержку радио RDA5807M.
...
Пункты отладки:
    ...
    04 - Коррекция напряжения преобразователя(Для регулировки по обратной связи)(Внимание! Значение может меняться в зависимости от напряжения питания)(+-25)
