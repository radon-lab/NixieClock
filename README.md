...
Пункты меню:
    ...
    01 - Бузер(Формат времени(12ч | 24ч)), Плеер(Глюки(0 - выкл | 1 - вкл) : Формат времени(12ч | 24ч))
    02 - Бузер(Глюки(0 - выкл | 1 - вкл)), Плеер(Голос озвучки(0 - Алёна | 1 - Филипп) : Громкость озвучки(0..15))
    03 - Бузер(Звук кнопок/секунд(0 - выкл | 1 - вкл звук кнопок | 2 - вкл звук кнопок и секунд) : Озвучка часа(0 - выкл | 1 - вкл), Плеер(Озвучка действий(0 - выкл | 1 - вкл) : Озвучка часа(Температура/Новый час))
