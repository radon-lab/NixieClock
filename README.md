...
Порядок записи нового загрузчика(потребуется isp программатор):
    ...
    6. Заходим в веб интерфейс, вкладка "обновление", загружаем файл прошивки часов(если окно начала загрузки не появится, значит нужно уменьшить длинну имени файла и убрать из имени все лишние точки).
    7. Зажимаем кнопку ресет на мк часов.
    8. Ждём появления окна о начале загрузки прошивки.
    9. Отпускаем кнопку ресет на мк часов.
    10. Ждём окончания загрузки.
