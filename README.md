...
Что планируется:
    ...
    Добавить возможность выбора перехода на зимнее/летнее время.
...
Пункты меню:
    ...
    02 - Глюки и озвучка смены часа (Озвучка часа(Температура/Новый час : Глюки(0 - выкл | 1 - вкл))
    03 - Звук кнопок и громкость озвучки (Громкость озвучки : Звук кнопок(0 - выкл | 1 - вкл))
    ...
    10 - Настройка интервала и анимации автоматического отображения(Время в минутах 0..15(0 - выключить) : Анимация)
    11 - Выбор анимации антиотравления индикаторов и анимации секунд(Антиотравление : Анимация секунд)
