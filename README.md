...
Настройка секундных точек:
    ...
    SECS_DOT 4 - Декатрон(пины подключения указывается в DECATRON_K0_PIN, DECATRON_K1_PIN, DECATRON_PK1_PIN и DECATRON_PK2_PIN)(возможно комбинирование с точками в индикаторах)
