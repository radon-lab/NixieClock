...
Если у вас установлена неоновая точка вместо светодиодной - то необходимо перед прошивкой установить в "config.h" - NEON_DOT 1(Можно использовать точки в индикаторах в качестве секундных - NEON_DOT 2).
