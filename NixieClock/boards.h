...
//#define CLOCK_BOARD_MODEL "" //модель платы часов(не более 15 символов)(можно записать только один раз)
//#define CLOCK_BOARD_SN "" //серийный номер платы часов(не более 5 символов)(можно записать только один раз)
