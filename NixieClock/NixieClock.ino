...
#define ADD_KEY_PRESS   7 //клик дополнительной кнопкой
#define ADD_KEY_HOLD    8 //удержание дополнительной кнопки
...
boolean alarmEnabled = 0; //флаг включенного будильника
boolean alarmWaint = 0; //флаг ожидания звука будильника
uint8_t alarm = 0; //флаг активации будильника
