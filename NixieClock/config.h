...
const uint8_t digitMask[] = {_MASK(7), _MASK(3), _MASK(6), _MASK(4), _MASK(1), _MASK(9), _MASK(8), _MASK(0), _MASK(5), _MASK(2), _MASK(10)}; //маска дешифратора платы in12 (цифры нормальные)(цифра "10" - это пустой символ, должен быть всегда в конце)
...
const uint8_t digitMask[] = {_MASK(2), _MASK(8), _MASK(1), _MASK(9), _MASK(6), _MASK(4), _MASK(3), _MASK(5), _MASK(0), _MASK(7), _MASK(10)}; //маска дешифратора платы in12 turned (цифры вверх ногами)(цифра "10" - это пустой символ, должен быть всегда в конце)
const uint8_t cathodeMask[] = {1, 6, 2, 7, 5, 0, 4, 9, 8, 3}; //порядок катодов in12
#elif (BOARD_TYPE == 2) //IN-14 (обычная и neon dot)
enum {DOT_POS, ANODE_4_POS, ANODE_3_POS, ANODE_2_POS, ANODE_1_POS}; //порядок анодов ламп(точки всегда должны быть первыми)(только для прямого подключения к микроконтроллеру)
const uint8_t digitMask[] = {_MASK(9), _MASK(8), _MASK(0), _MASK(5), _MASK(4), _MASK(7), _MASK(3), _MASK(6), _MASK(2), _MASK(1), _MASK(10)}; //маска дешифратора платы in14(цифра "10" - это пустой символ, должен быть всегда в конце)
const uint8_t cathodeMask[] = {1, 0, 2, 9, 3, 8, 4, 7, 5, 6}; //порядок катодов in14
#elif (BOARD_TYPE == 3) //другие индикаторы(4 лампы)
enum {DOT_POS, ANODE_1_POS, ANODE_2_POS, ANODE_3_POS, ANODE_4_POS}; //порядок анодов ламп(точки всегда должны быть первыми)(только для прямого подключения к микроконтроллеру)
const uint8_t digitMask[] = {_MASK(0), _MASK(1), _MASK(2), _MASK(3), _MASK(4), _MASK(5), _MASK(6), _MASK(7), _MASK(8), _MASK(9), _MASK(10)}; //тут вводим свой порядок пинов лампы(цифра "10" - это пустой символ, должен быть всегда в конце)
const uint8_t cathodeMask[] = {1, 6, 2, 7, 5, 0, 4, 9, 8, 3}; //порядок катодов in12
...
//Версия прошивки
#define FIRMWARE_VERSION "1.9.1"     //версия прошивки для отображения и озвучки
