...
#define DIGIT_MASK ID(0), ID(1), ID(2), ID(3), ID(4), ID(5), ID(6), ID(7), ID(8), ID(9), ID(10) //порядок соответствия выходов дешифратора цифрам в лампе(указывать через запятую, от цифры 0 до цифры 9)(ID(10) должен быть всегда в конце)(ID(0)..ID(10))
...
//Версия прошивки
#define FIRMWARE_VERSION "2.2.7"     //версия прошивки для отображения и озвучки
