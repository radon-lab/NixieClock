...
#define DEFAULT_BACKL_BRIGHT 25      //яркость подсветки ламп дневная(1..25)
#define DEFAULT_BACKL_BRIGHT_N 12    //яркость подсветки ламп ночная(0..25)(0 - подсветка выключена)
