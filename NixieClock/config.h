...
#define MIN_SQW_TIME 600             //минимальное время сигнала с пина SQW(500..1000)(мс)
...
#define DEBUG_PASS_SOUND_FREQ 500    //частота звука неверно введенного пароля(10..10000)(Гц)
#define DEBUG_PASS_SOUND_TIME 1500   //длительность звука неверно введенного пароля(500..5000)(мс)
