...
#define LAMP_NUM 4              //количесво ламп(4 или 6)
#define LAMP_REVERS 0           //отразить отображение информации на индикаторах(0 - нормальное отображение | 1 - зеркальное отображение)
