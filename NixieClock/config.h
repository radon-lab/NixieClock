...
#define DEFAULT_TEMP_SENSOR 0  //датчик температуры по умолчанию(0 - DS3231(встроенны) | 1 - BME/BMP_280(180) | 2 - DHT11/12 | 3 - DHT21/22(AM2301) | 4 - DS18B20)
...
const uint16_t _sound_1[][3] PROGMEM = { //массив семплов 1-й мелодии будильника || семпл - частота(10..10000)(Hz) | длительность звука(50..500)(ms) | длительность паузы(50..1000)(ms)
  {392, 350, 350}, {392, 350, 350}, {392, 350, 350}, {311, 250, 250}, 
  {466, 100, 100}, {392, 350, 350}, {311, 250, 250}, {466, 100, 100}, 
  {392, 700, 700}, {587, 350, 350}, {587, 350, 350}, {587, 350, 350},
  {622, 250, 250}, {466, 100, 100}, {369, 350, 350}, {311, 250, 250},
  {466, 100, 100}, {392, 700, 700}, {784, 350, 350}, {392, 250, 250},
  {392, 100, 100}, {784, 350, 350}, {739, 250, 250}, {698, 100, 100},
  {659, 100, 100}, {622, 100, 100}, {659, 450, 450}, {415, 150, 150},
  {554, 350, 350}, {523, 250, 250}, {493, 100, 100}, {466, 100, 100},
  {440, 100, 100}, {466, 450, 450}, {311, 150, 150}, {369, 350, 350},
  {311, 250, 250}, {466, 100, 100}, {392, 750, 1750}
};
