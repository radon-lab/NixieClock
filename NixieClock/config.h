...
#define HV_VCC 165              //напряжение питания ламп(150..190)(в)
#define HV_R_HIGH 680           //сопротевление верхнего плеча резисторного делителя(кОм)
#define HV_R_LOW 10             //сопротевление нижнего плеча резисторного делителя(кОм)
