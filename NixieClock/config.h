...
// 7 - волна (рекомендуемая скорость: 100-300)
// 8 - блики (рекомендуемая скорость: 100-300)
// 9 - испарение (рекомендуемая скорость: 100-300)
...
#define FLIP_MODE_5_TIME 100  //скорость шага эффекта номер 5(мс)
#define FLIP_MODE_6_TIME 80   //скорость шага эффекта номер 6(мс)
#define FLIP_MODE_7_TIME 200  //скорость шага эффекта номер 7(мс)
#define FLIP_MODE_8_TIME 200  //скорость шага эффекта номер 8(мс)
#define FLIP_MODE_9_TIME 200  //скорость шага эффекта номер 9(мс)

#define BACKL_MODE_8_TIME 30  //скорость шага эффекта подсветки номер 8(мс)
#define BACKL_MODE_9_TIME 80  //скорость шага эффекта подсветки номер 9(мс)
