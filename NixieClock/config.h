...
#define SLEEP_WAKE_TIME 5            //время ожидания после выхода из сна(3..240)(сек)

//Настройки таймера
#define TIMER_TIMEOUT 50             //тайм-аут выхода из таймера-секундомера по бездействию(5..60)(сек)
...
#define RESET_TIME_TEMP 10           //время ожидания автопоказа температуры если таймер истек и была перезагрузка основной программы(5..25)(сек)
#define RESET_TIME_BURN 10           //время ожидания антиотравления если таймер истек и была перезагрузка основной программы(5..25)(сек)
#define RESET_TIME_GLITCH 10         //время ожидания глюков если таймер истек и была перезагрузка основной программы(5..25)(сек)
...
//Версия прошивки
#define FIRMWARE_VERSION "1.7.3"     //версия прошивки для отображения и озвучки
