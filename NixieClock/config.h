...
#define RESET_TIME_SLEEP 5           //время ожидания сна если после автопоказа температуры и антиотравления(5..25)(сек)
...
//Версия прошивки
#define FIRMWARE_VERSION "1.7.7"     //версия прошивки для отображения и озвучки
