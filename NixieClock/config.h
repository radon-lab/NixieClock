...
#define LEDS_NUM (LAMP_NUM)          //количество светодиодов подсветки(только для светодиодов WS2812B)(LAMP_NUM..255)

#define LED_DIGIT_H1 0               //номер светодиода для первого разряда часа(0..255)
#define LED_DIGIT_H2 1               //номер светодиода для второго разряда часа(0..255)
#define LED_DIGIT_M1 2               //номер светодиода для первого разряда минут(0..255)
#define LED_DIGIT_M2 3               //номер светодиода для второго разряда минут(0..255)
#define LED_DIGIT_S1 4               //номер светодиода для первого разряда секунд(0..255)
#define LED_DIGIT_S2 5               //номер светодиода для второго разряда секунд(0..255)
