...
#define PLAYER_AMP_WAIT 100          //ожидание активации усилителя плеера(10..150)(мс)
#define PLAYER_UART_SPEED 9600       //скорость UART плеера(9600)

#define PLAYER_MIN_VOL 0             //минимальная громкость(DF - 0..30 | SD - 0..9)
#define PLAYER_MAX_VOL 30            //максимальная громкость(DF - 1..30 | SD - 1..9)

//Настройки радиоприемника
#define RADIO_STATIONS 877, 1025, 1057 //радиостанции(не более 9 пресетов)(870..1080)(МГц * 10)
#define RADIO_VOLUME 15              //громкость радио(0..15)
...
#define TEMP_START_TIME 1000         //ожидание инициализации датчиков температуры(500..2000)(мс)
...
#define IR_HOLD_ENABLE 1             //разрешить удержание кнопки пульта(0 - удержание запрещено | 1 - удержание разрешено)
...
//Версия прошивки
#define FIRMWARE_VERSION "1.6.7"     //версия прошивки для отображения и озвучки
