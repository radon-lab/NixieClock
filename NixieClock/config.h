...
#define BACKL_MODE_4_FADING 10       //количество шагов декркминента яркости эффекта подсветки номер 2(5..50)
#define BACKL_MODE_4_STEP 10         //шаг декркминента яркости эффекта подсветки номер 2(1..50)
#define BACKL_MODE_5_COLOR 5         //шаг изменения цвета эффекта подсветки номер 5(5..50)

#define BACKL_MODE_6_TIME 50         //скорость шага эффекта подсветки номер 6(4..150)(мс)
#define BACKL_MODE_6_STEP 2          //размер шага яркости эффекта подсветки номер 6(1..50)
