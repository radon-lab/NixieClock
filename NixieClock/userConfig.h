...
#define AUTO_TEMP_SHOW_TYPE 3      //формат отображения автоматического показа температуры(1 - температура | 2 - температура/влажность или температура/давление | 3 - температура/влажность/давление)
