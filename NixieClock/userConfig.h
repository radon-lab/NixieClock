...
#define ESP_ENABLE 1              //включить поддержку внешнего модуля ESP8266 на шине I2C(0 - модуль не используется | 1 - модуль используется)
...
#define ALARM_WAIT_BLINK_DOT 4     //режим мигания точек если ожидаем повторного сигнала(0 - выкл | 1 - статичная | 2 - без реакции | 3 - мигает один раз в секунду | 4 - мигает два раза в секунду)
