...
#define DEFAULT_FLIP_ANIM 1        //режим перелистывания цифр по умолчанию(0 - выкл | 1 - случайная смена эффектов | 2 - плавное угасание и появление | 3 - перемотка по порядку числа | 4 - перемотка по порядку катодов в лампе | 5 - поезд | 6 - резинка | 7 - ворота | 8 - волна | 9 - блики | 10 - испарение | 11 - игровой автомат)
