...
#define BACKL_MODE 0              //режим подсветки на обычных светодиодах(0 - хардверный шим(только D11)(только без SD карты и хардверным UART) | 1 - софтверный шим(любой пин))
...
#define PLAYER_MODE 0             //использовать DF плеер вместо бузера(0 - бузер | 1 - DF плеер | 2 - SD карта)
