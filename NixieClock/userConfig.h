...
#define BACKL_MODE 0              //режим подсветки на обычных светодиодах(0 - хардверный шим(только D11)(только без SD плеера и хардверным UART) | 1 - софтверный шим(любой пин))
