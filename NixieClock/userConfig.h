...
#define SECONDS_ANIM_1_TIME 490    //период смены яркости эффекта анимации секунд 1(только для 6-ти ламп)(250..500)(мс)
...
#define FLIP_MODE_2_TIME 490       //период смены яркости эффекта номер 2(250..1000)(мс)
