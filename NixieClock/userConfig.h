...
#define GLITCH_PHASE_MIN 10        //минимальное смещение фазы периода отображения глюков(5..55)(с)
#define GLITCH_PHASE_MAX 50        //максимальное смещение фазы периода отображения глюков(5..55)(с)
...
#define BURN_PHASE 25              //смещение фазы периода антиотравления(5..55)(с)
...
#define AUTO_TEMP_PHASE 10         //смещение фазы периода автоматического показа температуры(5..55)(с)
