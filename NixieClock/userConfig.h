...
#define BACKL_TYPE 0              //тип родсветки индикаторов(0 - хардверный шим(обычные светодиоды)(только D11)(только без SD плеера и хардверным UART) | 1 - софтверный шим(обычные светодиоды)(любой пин) | 2 - светодиоды WS2812B(любой пин))
