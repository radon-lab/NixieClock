...
#define INDI_TYPE 0               //тип подключения анодов индикаторов и разделительных точек(двух неоновых ламп)(0 - прямое подключение к микроконтроллеру | 1 - подключение через сдвиговый регистр)
