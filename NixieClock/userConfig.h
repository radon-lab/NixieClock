...
//Настройки индикации
#define INDI_PORT_TYPE 0          //тип подключения анодов числовых индикаторов(0 - прямое подключение к микроконтроллеру | 1 - подключение через сдвиговый регистр)
#define INDI_SYMB_TYPE 0          //тип подключения анодов символьного индикатора(0 - лампа не используется | 1 - прямое подключение к микроконтроллеру | 2 - подключение через сдвиговый регистр)

#define INDI_DOT_TYPE 0           //тип подключения секундных неоновых точек при использовании сдвигового регистра(0 - прямое подключение к микроконтроллеру | 1 - подключение через сдвиговый регистр)
