...
#define BOARD_TYPE 0              //тип платы часов(0 - другие индикаторы(платы)(настройка в config.h) | 1 - [AlexGyver v2] ИН12 (индикаторы стоят правильно) | 2 - [AlexGyver v2] ИН12 turned (индикаторы перевернуты) | 3 - [AlexGyver v2] ИН14 (обычная и неоновая точка))
...
//Настройки декатрона
#define DECATRON_ENABLE 0         //включить поддержку декатрона(0 - декатрон не используется | 1 - декатрон используется)
