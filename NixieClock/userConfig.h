...
#define AHT_SHT_ENABLE 0          //включить поддержку датчиков температуры AHT1x и AHT2x(0 - датчик не используется | 1 - используется датчик AHT10/AHT15 | 2 - используется датчик AHT20)
