...
#define AUTO_SHOW_MODES 0, 1, 2    //выбранные режимы отображения данных автоматического показа(указывать через запятую)(0 - температура | 1 - влажность | 2 - давление | 3 - температура и влажность | 4 - дата | 5 - год | 6 - дата и год)
#define AUTO_SHOW_TIMES 5, 5, 5    //задержки выбранных режимов отображения данных автоматического показа(указывать через запятую)(1..5)(сек)
