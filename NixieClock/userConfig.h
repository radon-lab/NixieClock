...
#define DEFAULT_SECONDS_ANIM 1     //режим анимации секунд по умолчанию(только для 6-ти ламп)(0 - выкл | 1 - плавное угасание и появление | 2 - перемотка по порядку числа | 3 - перемотка по порядку катодов в лампе)
...
#define DOT_RUNNING_TIME 1000      //период анимации "бегущая точка" для точек в индикаторах(250..1000)(мс)
#define DOT_SNAKE_TIME 900         //период анимации "змейка" для точек в индикаторах(500..1000)(мс)
#define DOT_TURN_TIME 500          //время переключения точек в индикаторах(или двух неоновых ламп) для анимации "маятник" (100..500)(0 - один раз в секунду)(мс)
