...
#define SECS_DOT 0                //тип секундных точек(0 - точка светодиод | 1 - точка неоновая лампа(1 шт) | 2 - точка неоновая лампа(2 шт) | 3 - точка в индикаторе | 4 - точка в декатроне)
