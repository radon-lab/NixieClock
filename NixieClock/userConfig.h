...
#define AUTO_SHOW_DATE_BLINK 0     //мигать датой/годом при отображении при автоматическом показе(0 - статичное отображение | 1 - мигание даты/года)
#define AUTO_SHOW_DATE_TIME 50     //время мигания датой/годом при отображении при автоматическом показе(20..100)(мс)
