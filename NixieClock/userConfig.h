...
#define ALARM_ON_BLINK_DOT 1       //режим мигания точек если хоть один будильник включен(0 - без реакции | 1 - мигает один раз в секунду | 2 - мигает два раза в секунду | 3 - выкл | 4 - статичная | 5 - динамичная(плавно мигает)), (для двух неоновых ламп)(6 - маятник), (для точек в индикаторах)(6 - мигающая | 7 - бегущая | 8 - змейка | 9 - резинка | 10 - одинарный маятник(только для 6-ти ламп или если используются левые и правые точки) | 11 - двойной маятник(только для 6-ти ламп и если используются левые и правые точки))
#define ALARM_WAIT_BLINK_DOT 2     //режим мигания точек если ожидаем повторного сигнала(0 - без реакции | 1 - мигает один раз в секунду | 2 - мигает два раза в секунду | 3 - выкл | 4 - статичная | 5 - динамичная(плавно мигает)), (для двух неоновых ламп)(6 - маятник), (для точек в индикаторах)(6 - мигающая | 7 - бегущая | 8 - змейка | 9 - резинка | 10 - одинарный маятник(только для 6-ти ламп или если используются левые и правые точки) | 11 - двойной маятник(только для 6-ти ламп и если используются левые и правые точки))
