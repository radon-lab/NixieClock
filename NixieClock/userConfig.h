...
#define SENS_PORT_ENABLE 0        //включить использование порта датчиков температуры DS18xx и DHTxx(0 - порт не используется | 1 - порт используется для DS18xx | 2 - порт используется для DHTxx | 3 - порт используется для DS18xx и DHTxx)
...
#define DEFAULT_TEMP_CORRECT 0     //коррекция температуры по умолчанию(-127..127)(0.1°c)(поддерживаются датчики - DS3231(встроенный), AHT10/AHT15/AHT20, SHT20/SHT21/SHT25/SHT30/SHT31/SHT35, BMP180/BMP085/BMP280/BME280, DHT11/DHT12/MW33, DHT21/DHT22(AM2301/AM2302), DS18B20/DS18S20/DS1820)
