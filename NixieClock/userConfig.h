...
#define GLITCH_MIN_TIME 40         //минимальное время между глюками(10..60)(с)
...
#define BURN_PHASE 0               //фаза отображения анимации антиотравления(необходимо учитывать фазу отображения автоматического показа температуры и анимации смены минут)(0..59)(с)
...
#define DEFAULT_AUTO_TEMP_TIME 1   //интервал автоматического показа температуры по умолчанию(0..15)(0 - выключить автоматический показ)(м)
...
#define AUTO_TEMP_PHASE 30         //фаза отображения автоматического показа температуры(необходимо учитывать фазу отображения антиотравления и анимации смены минут)(0..59)(с)
