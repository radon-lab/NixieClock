...
#define DEFAULT_SECONDS_ANIM 1     //режим постоянной анимации секунд(только для 6-ти ламп)(0 - выкл | 1 - плавное угасание и появление | 2 - перемотка по порядку числа)
