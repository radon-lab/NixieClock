...
#define SHOW_TEMP_COLOR_T 170      //цвет показаний температуры(0..255)(только для светодиодов WS2812B)
#define SHOW_TEMP_COLOR_P 0        //цвет показаний давления(0..255)(только для светодиодов WS2812B)
#define SHOW_TEMP_COLOR_H 85       //цвет показаний влажности(0..255)(только для светодиодов WS2812B)
#define SHOW_TEMP_BACKL_N 0        //цвет незначащих разрядов меню температуры(0..255)(только для светодиодов WS2812B)
