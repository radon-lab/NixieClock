...
#define SLEEP_START_TIME 5          //время ожидания после после включения питания(0..30)(шаг 5)(сек)
...
#define AUTO_TEMP_SHOW_HUM 0       //отображать влажность вместе с температурой(только для 6-ти ламп)(0 - только температура | 1 - температура и влажность)
...
#define ALARM_TYPE 1               //использовать только один будильник(0 - будильник отключен | 1 - один будильник | 2 - неограниченое количество будильников)
...
#define DEFAULT_ALARM_VOLUME 0     //громкость будильника по умолчанию(DF - 0..30 | SD - 0..9)(0 - нарастающий сигнал)
...
#define ALARM_AUTO_VOL_MIN 5       //минимальная громкость будильника в авто режиме(DF - 0..30 | SD - 0..9)
#define ALARM_AUTO_VOL_MAX 20      //максимальная громкость будильника в авто режиме(DF - 0..30 | SD - 0..9)
...
#define RADIO_BACKL_COLOR_2 0      //цвет неактивного разрядов меню радио(0..255)
