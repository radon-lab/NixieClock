...
#define BOARD_TYPE 0              //тип платы часов(0 - другие индикаторы(платы)(настройка маски в config.h) | 1 - [AlexGyver v2] ИН12 (индикаторы стоят правильно) | 2 - [AlexGyver v2] ИН12 turned (индикаторы перевернуты) | 3 - [AlexGyver v2] ИН14 (обычная и неоновая точка))
