//Язык веб интерфейса
#define ENGLISH //для смены языка необходимо указать один из вариантов(по умолчанию доступны - RUSSIAN(Русский) и ENGLISH(Английский), либо добавить свои метаданные в файл "languages")
