...
#define DEFAULT_CLIMATE_BAR 0 //режим отображения данных о погоде в баре по умолчанию(0 - передаются данные с датчика температуры | 1 - передаются данные погоды)
#define DEFAULT_CLIMATE_SEND 0 //режим передачи данных о погоде в часы по умолчанию(0 - отображаются данные с датчика температуры | 1 - отображаются данные погоды)
...
#define ESP_FIRMWARE_VERSION "1.2.2" //версия прошивки модуля esp
