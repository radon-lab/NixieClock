...
.inliner{display:flex;flex-direction:row;flex-wrap:nowrap;justify-content:center;align-content:center;align-items:center;width:100%;}
...
.header{white-space:nowrap;font-size:25px;color:#fff;}
