...
.mainblock{margin:auto;max-width:100%;overflow-x:hidden;}
p{display:inline;}
...
body{font-family:Verdana;background:#13161a;color:#bbb;margin:9px 8px;}
...
@media screen and (max-width:450px){body{margin:9px 0 9px 0;}}
