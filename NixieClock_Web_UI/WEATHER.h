...
const char *weatherStatusList[] = {LANG_WEATHER_STATUS_1, LANG_WEATHER_STATUS_2, LANG_WEATHER_ATTEMPT, LANG_WEATHER_STATUS_3, LANG_WEATHER_STATUS_4, LANG_WEATHER_STATUS_5};
