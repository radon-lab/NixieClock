...
#define RTC_MODUL 1                  //использовать модуль часов или вести счет времени внутренним счетчиком(время будет сбрасываться после отключения питания)(0 - модуль RTC используется | 1 - модуль не RTC используется).
...
#define ALARMS_NUM 5                 //количество будильников(1..10)
...
#define ANSWER_SEND_ALARM 0x11          //команда ответа будильников
