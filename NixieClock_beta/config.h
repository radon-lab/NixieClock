...
#define DEFAULT_INDI_BRIGHT_N 2      //яркость цифр ночная по умолчанию(0..30)
...
#define DEFAULT_DOT_BRIGHT 100       //яркость точки дневная по умолчанию(1..255)
#define DEFAULT_DOT_BRIGHT_N 44      //яркость точки ночная по умолчанию(1..255)
#define DEFAULT_DOT_TIMER 4          //шаг яркости точки по умолчанию(4..255)(мс)
#define DEFAULT_DOT_TIME 200         //время мигания точки по умолчанию(100..1000)(мс)
...
#define EEPROM_BLOCK_SETTINGS_MAIN 42   //блок памяти основных настроек
