...
#define EEPROM_BLOCK_SETTINGS_MAIN 46   //блок памяти основных настроек
...
#define COMMAND_SEND_ALARM 0x52         //команда отправить настройки будильников
#define COMMAND_GET_ALARM 0x53          //команда принять настройки будильников
#define COMMAND_SEND_SET_BRIGHT 0x54    //команда отправить настройки свечения
#define COMMAND_GET_SET_BRIGHT 0x55     //команда принять настройки свечения
#define COMMAND_SEND_SET_MAIN 0x56      //команда отправить основные настройки
#define COMMAND_GET_SET_MAIN 0x57       //команда принять основные настройки
...
#define ANSWER_SEND_SET_BRIGHT 0x12     //команда ответа настроек свечения
#define ANSWER_SEND_SET_MAIN 0x13       //команда ответа основных настроек
