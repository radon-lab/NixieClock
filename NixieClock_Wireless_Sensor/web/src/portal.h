...
class GyverPortalMod : public TimeTicker, public ArgParser {
  public:
    ...
    void attach(void (*handler)(GyverPortalMod& p)) {
      _actionR = *handler;
    }
    ...
    void attachBuild(void (*handler)(GyverPortalMod& p)) {
      _buildR = *handler;
    }
  ...
  private:
    ...
    void (*_build)() = nullptr;
    void (*_buildR)(GyverPortalMod& p) = nullptr;
    void (*_action)() = nullptr;
    void (*_actionR)(GyverPortalMod& p) = nullptr;
