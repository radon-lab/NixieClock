//Основные настройки
#define AP_IP 192, 168, 15, 15 //адрес точки доступа(по умолчанию - 192, 168, 15, 15)
...
#define BAT_VOLTAGE_CORRECT 100 //минимальное напряжение для расчета заряда батареи(-200..200)(мВ)

#define SET_BTN_PIN 3 //пин кнопки входа в настройки(0,2,3,4,5)(GPIO)
...
//Дополнительно
#define DEBUG_MODE 1 //режим отладки прошивки(0 - выкл | 1 - вкл)

#define MAX_CLOCK 4 //максимум часов для отправки данных(2..5)

#define UDP_SEND_SIZE 9 //размер пакета данных(9)
